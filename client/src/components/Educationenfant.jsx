...
import dessinImg from "../assets/dessin.png";

const activities = [
  { id: 1, label: "Puzzle", path: "/puzzle", image: puzzleImg },
  { id: 2, label: "Minilecteur", path: "/minilecteur", image: minilecteurImg },
  { id: 3, label: "Dessin", path: "/drawing", image: dessinImg },
];

const Educationenfant = () => {
...
export default Educationenfant;
